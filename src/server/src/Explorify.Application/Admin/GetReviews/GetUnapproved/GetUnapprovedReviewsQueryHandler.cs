...
public class GetUnapprovedReviewsQueryHandler :
    IQueryHandler<GetUnapprovedReviewsQuery, AdminReviewsListResponseModel>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            var userDto = usersDtos.FirstOrDefault(x => x.Id.ToString().ToUpper() == review.UserId.ToString());
